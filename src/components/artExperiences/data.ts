...
export const artEvents: ArtEvent[] = [
  {
    ...
    currency: 'CAD',
    image: '',
    eventbriteUrl: 'https://www.eventbrite.ca/e/paint-sip-afternoon-with-artist-camilalonart-tickets-1989845854516',
    flockUrl: 'https://flocksocial.app/e/paint-sip-afternoon-with-artist-camilalonart-02bf9a',
    tags: ['paint & sip', 'beginner-friendly', 'social', 'coffee bar', 'guided painting'],
    featured: true,
  ...
  {
    id: 'painting-class-june-23-2026',
    type: 'myEvents',
    title: {
      en: 'Painting Class',
      es: 'Clase de Pintura',
    ...
    description: {
      en: "A relaxed, beginner-friendly guided paint & sip experience where we'll create together step by step while enjoying drinks, music, and a warm atmosphere. All painting materials will be provided.",
      es: 'Una experiencia relajada y apta para principiantes donde crearemos juntos paso a paso mientras disfrutamos bebidas, música y una atmósfera cálida. Todos los materiales de pintura serán proporcionados.',
    },
    date: 'Saturday, June 23, 2026',
    dateISO: '2026-06-23',
    time: '2:00 PM',
    venue: 'FUNK Coffee Bar',
    address: '1025 Dunsmuir St',
